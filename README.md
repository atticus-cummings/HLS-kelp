...
./process data/
    ...
    Windows/
       - kmeans_usupervised_classifier.ipynb - This script helps you create classified kelp imagery for model training. It utilizes kmeans classification to bin similar pixels, which can then be manually sorted through and assigned a classification. This approach produces impefect training data. 
